...
<body>
	...
	<center>
		<fieldset style="width: 400px">
			<legend>User Information Fields</legend>
			<table class="table table-hover table-striped text-center">

				<tr>
					<td><img class="img-rounded"
						src="message/${receiver.id}/photo" width="150" height="150" /></td>
				</tr>
				<tr>
					<td>User Name:</td>
				...
				<tr>
					<td>Education:</td>
					<td>${receiver.education}</td>
				</tr>
				<tr>
					<td>Work Experience:</td>
					<td>${receiver.workExperience}</td>
				</tr>
				<tr>
					<td>Introduction:</td>
					<td>${receiver.introduction}</td>
				</tr>
			</table>
		</fieldset>
	</center>
	<div align="center">
		<form:form role="form" modelAttribute="Message"
			action="/myapp/message/${receiver.id}/send" method="post">
			<fieldset style="width: 200px">
				<legend>Message Fields</legend>
				<p>
					<form:label for="content" path="content" cssErrorClass="error">Message:</form:label>
					<br />
					<form:textarea placeholder="Please enter some Message then send to this user."
						path="content" />
