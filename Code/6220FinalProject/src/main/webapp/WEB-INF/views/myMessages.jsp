...
<body>
	...
	<div id="header">
		<ul class="nav nav-tabs ">
			...
			<li class="active"><a
				href="<c:url value='/message/myMessages'/>">My Message</a></li>
	...
	<center>
		<c:if test="${!empty messages}">
			<fieldset style="width: 600px">
				<legend>All your Messages.</legend>
				<div class="container" style="width: 500px">
					<ul class="media-list">
						<c:forEach var="message" items="${messages}">
							<li class="media"><a class="pull-left" href="#"> <img
									class="media-object"
									src="<c:url value='${message.senderId}/message/${message.senderId}/photo'/>"
									width="50" height="50">
							</a>
								<div class="media-body">
									<h4 class="media-heading">
										<a
											href="<c:url value='/message/${message.senderId}/messageForm'/>"><c:out
												value="${message.senderName}"></c:out></a>
									</h4>
									<div>${message.content}</div>
									<div class="text-right">${message.sendDate}</div>
								</div></li>
						</c:forEach>
					</ul>
				</div>
