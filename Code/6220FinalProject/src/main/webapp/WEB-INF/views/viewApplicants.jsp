		...
		<div>
			<c:if test="${!empty applications}">
				<fieldset style="width: 600px">
					<legend>All the applicants for this job.</legend>
					<table class="table table-hover text-center">
						...
						<c:forEach var="application" items="${applications}">
							<tr>
								...
								<td><a
									href="<c:url value='/message/${application.applicant.id}/messageForm'/>"><c:out
											value="${application.applicant.username}"></c:out></a></td>
