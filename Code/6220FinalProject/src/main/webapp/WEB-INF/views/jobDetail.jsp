...
<body>
	...
	<fieldset style="width: 400px">
		<legend>Job Detail Information</legend>
		<table class="table table-striped">
			<tbody>
				<tr>
					<td>Publisher Name</td>
					<td>${jobInfo.user.username}</td>
				</tr>
				<tr>
					<td>Publisher Email</td>
					<td>${jobInfo.user.email}</td>
				</tr>
				<tr>
					<td>Title</td>
					<td>${jobInfo.title}</td>
				...
				<tr>
					<td>Due Date</td>
					<td>${jobInfo.duedate}</td>
				</tr>
				<tr>
					<td>Publish Date</td>
					<td>${jobInfo.publishDate}</td>
				</tr>
				<tr>
					<td>Job Introduction</td>
					<td>${jobInfo.introduction}</td>
				</tr>
			</tbody>
	...
	<sec:authorize access="hasAuthority('employee')">
		<div align="center">
			<form:form role="form" class="" modelAttribute="Application"
				action="/myapp/application/${jobInfo.id}/apply" method="post">
				<fieldset style="width: 200px">
					<legend>Application Fields</legend>
					<p>
						<form:label for="content" path="content" cssErrorClass="error">Application:</form:label>
						<br />
