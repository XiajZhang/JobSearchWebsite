...
<body>
	...
	<div id="header">
		<ul class="nav nav-tabs ">
			...
			<li><a href="<c:url value='/jobs/searchJobs'/>">Search
					for Job</a></li>
			<sec:authorize access="hasAuthority('employer')">
				<li><a href="<c:url value='/jobs/publish'/>">Publish Jobs</a></li>
			</sec:authorize>
			<sec:authorize access="hasAuthority('employee')">
				<li class="active"><a href="<c:url value='/application/viewAll'/>">My
						Application</a></li>
			</sec:authorize>
			<sec:authorize access="hasAuthority('employer')">
			...
			<table class="table table-hover text-center">
				...
				<c:forEach var="application" items="${applications}">
					<tr>
						...
						<td><a
							href="<c:url value='/jobs/${application.job.id}/showDetail'/>"><c:out
									value="${application.job.title}"></c:out></a></td>

						<td><c:out value="${application.job.position}"></c:out></td>

						<td><c:out value="${application.content}"></c:out></td>

						<td><c:out value="${application.applyDate}"></c:out></td>
