...
<body>
	...
	<div id="header">
		<ul class="nav nav-tabs ">
			...
			<li class="active"><a href="<c:url value='/userInfo'/>">Person
					Information</a></li>
	...
	<div class="panel panel-default congras2 text-success" style="width: 60%;">
		<div class="text-center panel-body">
			<p>Job Offer Published!</p>
		</div>
	</div>
	<div class="text-center"><a class="congrasL" href="<c:url value='/jobs/publish'/>">Publish Another One</a></div>
	</center>
	<!-- jQuery library -->
	<script
