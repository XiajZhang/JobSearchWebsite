...
<body>
	...
	<div id="header">
		<ul class="nav nav-tabs ">
			...
			<sec:authorize access="hasAuthority('employer')">
				<li class="active"><a href="<c:url value='/jobs/viewPublished'/>">Published
						Job Offer</a></li>
			</sec:authorize>
	...
	<div align=center>
		...
		<c:if test="${!empty jobs}">
			<fieldset style="width: 600px">
				<legend>All your published job.</legend>
				...
				<c:forEach var="jobInfo" items="${jobs}">
					<div class="row">
						...
						<div class="col-md-3">
							<a
								href="<c:url value='/application/${jobInfo.id}/viewAllApplicants'/>">View
								Applicants</a>
						</div>
						<div class="col-md-2">
							<a
								href="<c:url value='/jobs/${jobInfo.id}/editOffer'/>">Edit Job Offer</a>
						</div>
