...
<body>
	...
	<div id="header">
		<ul class="nav nav-tabs ">
			...
			<li class="active"><a href="<c:url value='/jobs/searchJobs'/>">Search for
					Job</a></li>
		...
		<div>
			<div class="header">
				<div align=center class="form-group">
					<form action="<c:url value='/jobs/searchJobs'/>" method=GET>
						<p class="enter">Enter the position you are interested in:</p>
						<input type=text class="form-control"
							style="width: 200px; margin: 10px; padding: 10px"
							name="searchString" /> <input type=submit class="btn btn-info"
